...
public final class EntityUbicoException extends UbicoException {

	private static final long serialVersionUID = 1L;
	private static final Lugar lugar = Lugar.ENTITY;

	public EntityUbicoException(final String mensajeUsuario) {
		super(mensajeUsuario, lugar);
	}

	public EntityUbicoException(final String mensajeTecnico, final String mensajeUsuario) {
